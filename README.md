...
Setup iniziale: Apri il terminale e per clonare il repository lancia: 
...
Credenziali di Prova (Default)
Se non modificate nel file .env o nel docker-compose.yml, le credenziali di default per il database sono:
 - User: admin
 - Password: (Da verificare nel file .env generato, solitamente configurata al primo avvio)
...
<img width="1100" height="2100" alt="Kubernetes Container-2026-02-24-104409" src="https://github.com/user-attachments/assets/efbfc2f9-3c35-47b3-ac16-ad754002d71d" />
